...
def generate_video():
   # Define the content to be used for generation
    ...
    check1= request.form['checklsit1']
    check2= request.form['checklsit2']
    check3= request.form['checklsit3']
    check4= request.form['checklsit4']
    ...
    response = client.chat.completions.create(
      ...
      messages=[
        {"role": "system", "content": "You are a helpful assistant."},
        {"role": "user", "content": f"give a short {check1} about {x}"},
        {"role": "assistant", "content": input_text },
    ...
    response = client.chat.completions.create(
      ...
      messages=[
        {"role": "system", "content": "You are a helpful assistant."},
        {"role": "user", "content": f"explain the {check2} of {x}"},
        {"role": "assistant", "content": input_text },
    ...
    response = client.chat.completions.create(
      ...
      messages=[
        {"role": "system", "content": "You are a helpful assistant."},
        {"role": "user", "content": f"explain the {check3} of {x}"},
        {"role": "assistant", "content": input_text },
    ...
    response = client.chat.completions.create(
      ...
      messages=[
        {"role": "system", "content": "You are a helpful assistant."},
        {"role": "user", "content": f"explain the {check4} of {x}"},
        {"role": "assistant", "content": input_text },
